...
def oneLight(strip, color, wait_ms=50):
    """One light progressing thru strip"""
...
def oneLightBack(strip, color, wait_ms=50):
    """Goin back"""
    for k in reversed(range(0, LED_COUNT)):
